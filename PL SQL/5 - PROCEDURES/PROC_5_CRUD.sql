...
--CONSTRAINT CK_SITUA CHECK(SITUACAO IN('B','A')) -> só poderá receber esses valores
  ...
  ELSIF (V_OPER = 'A') THEN
     ...
     THEN
        ...
        ELSE
           ...
           -- Se receber parametros nulo, vai permanecer o valor já existente.
      end if;  
...
DECLARE
    ...
    BEGIN
      ...
      P_ID:=1;
      P_NOME:='NOME1';
      P_EMAIL:='NOME1@EMAIL.COM';
      P_SIT:='B';
    
        SP_CRUD(P_OPER,P_ID,P_NOME,P_EMAIL,P_SIT);
END;

--REALIZANDO A CONSULTA DO VALOR INSERIDO
DECLARE
    P_OPER CHAR(1);
    P_ID INT;
    P_NOME VARCHAR2(50);
...
--REALIZANDO SELECT COM VALOR INEXISTENTE
DECLARE
    P_OPER CHAR(1);
    P_ID INT;
    P_NOME VARCHAR2(50);
...
-- REALIZANDO ERRO DE INSERT, ID JÁ EXISTENTE
DECLARE
    P_OPER CHAR(1);
    P_ID INT;
    P_NOME VARCHAR2(50);
    ...
    BEGIN
      ...
      P_ID:=1;
      P_NOME:='NOME2';
      P_EMAIL:='NOME2@EMAIL.COM';
      P_SIT:='B';
    
        SP_CRUD(P_OPER,P_ID,P_NOME,P_EMAIL,P_SIT);
END;

-- REALIZANDO UPDATE, ID JÁ EXISTENTE, E-MAIL NULL
DECLARE
    P_OPER CHAR(1);
    P_ID INT;
    P_NOME VARCHAR2(50);
