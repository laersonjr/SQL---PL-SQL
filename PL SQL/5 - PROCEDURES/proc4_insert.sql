...
create table table_copy_employess(EMPLOYEE_ID NUMBER(6,0) PRIMARY KEY, 
	FIRST_NAME VARCHAR2(20 BYTE), 
	LAST_NAME VARCHAR2(25 BYTE), 
	EMAIL VARCHAR2(25 BYTE), 
	PHONE_NUMBER VARCHAR2(20 BYTE), 
...
CREATE OR REPLACE
PROCEDURE proc_copy_employees
IS
    
BEGIN    
    insert into table_copy_employess select * from HR.employees;
    COMMIT;
EXCEPTION 
    WHEN OTHERS THEN
    DBMS_OUTPUT.PUT_LINE('ERRO: '||sqlerrm);
...
execute proc_copy_employees;

select count(*) from table_copy_employess;