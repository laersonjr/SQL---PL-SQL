...
-- evidencia
 select * from matricula;
  ...
  -- LEFT JOIN Trazendo todos os campos que estão associados
	SELECT a.nome,c.nome_disc,b.periodo
	FROM alunos a
  ...
  -- LEFT JOIN Tranzendo os campos que estão presente apenas na tabela "a" e ausente das outras tabelas    
    select a.nome, c.nome_disc, b.periodo
    from alunos a
    left join matricula b
        on a.id_aluno = b.id_aluno
 ...
 -- RIGHT JOIN Tranzendo os campos que estão presente apenas na tabela "b" e ausente das outras tabelas       
    select a.nome, c.nome_disc, b.periodo
    from alunos a
    right join matricula b
        on a.id_aluno=b.id_aluno
  ...
  -- Trazendo o mesmo resultado através do left join  
