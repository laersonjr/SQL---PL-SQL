...
select sysdate,
        to_char(sysdate,'day, dd "de" Month "de" YYYY "horário" hh24:mi:ss')Data_escrita from dual;
...
select to_char(sysdate, 'hh:mi:ss') as "HH MM SS",
       to_char(sysdate, 'scc') as "Século",
       to_char(sysdate, 'q') as "Trimestre",
       to_char(sysdate, 'yyyy-mm-dd hh24:mi:ss') as "Data completa"
       from dual;
