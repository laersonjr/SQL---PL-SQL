...
-- evidencia de erro	
	...
	-- OPERADOR HAVING retorna todos os estados com mais de 500 mun
	...
	-- OPERADOR HAVING retorna todos os estados com menos de 500 mun
	...
	-- OPERADOR HAVING retorna estados com a soma de populacao > 5000000
    ...
    select cod_uf, estado, nome_mun, populacao 
    from senso 
    where ano='2014' and cod_uf='42';
    
    select cod_uf, estado, sum(populacao) 
    from senso where ano='2014' and cod_uf='42' 
