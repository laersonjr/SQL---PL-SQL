...
CREATE GLOBAL TEMPORARY TABLE minha_temp2 (
  id           NUMBER,
  nome  VARCHAR2(20)
)
...
INSERT INTO minha_temp2 VALUES (1, 'Teste1');
INSERT INTO minha_temp2 VALUES (2, 'Teste2');
INSERT INTO minha_temp2 VALUES (3, 'Teste3');
commit;
-- analisando counteudo
SELECT COUNT(*) FROM minha_temp2;
-- desconecta
--reconecta
commit;
